(function (global, factory) {
	...
	(factory((global['ngx-webcam'] = {}),global.ng.core,global.ng.common));
...
var WebcamComponent = /** @class */ (function () {
    ...
    Object.defineProperty(WebcamComponent.prototype, "videoWidth", {
         ...
         */
        get: function () {
            var /** @type {?} */ videoRatio = this.activeVideoSettings ? this.activeVideoSettings.aspectRatio : (this.width / this.height);
    ...
    WebcamComponent.prototype.initWebcam = function (deviceId, userVideoTrackConstraints) {
        ...
        if (navigator.mediaDevices && navigator.mediaDevices.getUserMedia) {
            ...
            navigator.mediaDevices.getUserMedia(/** @type {?} */ ({ video: videoTrackConstraints }))
                ...
                var /** @type {?} */ activeDeviceId = stream.getVideoTracks()[0].getSettings().deviceId;
...
WebcamComponent.propDecorators = {
    ...
    'allowCameraSwitch': [{ type: core.Input },],
    'imageCapture': [{ type: core.Output },],
    'initError': [{ type: core.Output },],
    'imageClick': [{ type: core.Output },],
    'cameraSwitched': [{ type: core.Output },],
    'video': [{ type: core.ViewChild, args: ['video',] },],
    'canvas': [{ type: core.ViewChild, args: ['canvas',] },],
    'trigger': [{ type: core.Input },],
    'switchCamera': [{ type: core.Input },],
};
var COMPONENTS = [
    WebcamComponent
];
